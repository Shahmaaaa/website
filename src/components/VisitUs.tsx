    ...
    <section id="visit" className="section" style={{ background: 'linear-gradient(135deg, #2b1b11 0%, #5a3b22 35%, #a0683a 65%, #e8c99a 100%)', borderBottom: '1px solid rgba(198, 134, 66, 0.08)' }}>
      <div className="container">
        ...
        <div className="section-header fade-in-on-scroll visible" style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
          <span className="section-subtitle" style={{ letterSpacing: '0.15em', fontWeight: 600, color: '#e3a564' }}>EXPERIENCE THE COMFORT</span>
        ...
        <div className="visit-grid">
          ...
          <div className="visit-info-left fade-in-on-scroll visible">
            <p className="visit-description" style={{ fontSize: '0.95rem', color: 'rgba(255,255,255,0.85)', marginBottom: '2rem', lineHeight: '1.7' }}>
            ...
            <ul className="contact-details-list" style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '1.5rem', marginBottom: '2.5rem' }}>
              <li className="contact-item" style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                ...
                <div>
                  <h4 className="contact-item-title" style={{ fontSize: '0.95rem', fontWeight: 700, color: '#ffffff', marginBottom: '0.2rem' }}>Our Address</h4>
                  <p className="contact-item-value" style={{ fontSize: '0.88rem', color: 'rgba(255,255,255,0.75)', lineHeight: '1.5' }}>
              ...
              <li className="contact-item" style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                ...
                <div>
                  <h4 className="contact-item-title" style={{ fontSize: '0.95rem', fontWeight: 700, color: '#ffffff', marginBottom: '0.2rem' }}>Phone Number</h4>
          ...
          <div className="visit-map-right fade-in-on-scroll visible delay-2" style={{ border: '1px solid rgba(198, 134, 66, 0.3)', padding: '0.75rem', borderRadius: 'var(--radius-md)', backgroundColor: 'rgba(255,255,255,0.08)', boxShadow: 'var(--shadow-md)' }}>
            <iframe
